 ...
 * Original file: /npm/lil-gui@0.19.2/dist/lil-gui.esm.js
 *
...
class o extends t {
    constructor(t, i, n, s) {
        ...
        super(t, i, n, "color"),
            ...
            (this._format =
                ((l = this.initialValue), r.find((t) => t.match(l)))),
            (this._rgbScale = s),
...
class d extends t {
    ...
    updateDisplay() {
        ...
        return (
            ...
            (this.$display.textContent = -1 === i ? t : this._names[i]),
            this
        );
    }
}
...
//# sourceMappingURL=/sm/aa580bdcdd8a9a47e7c92c70558abfc622f05566261f453e8d0d1b43a166bfb6.map
